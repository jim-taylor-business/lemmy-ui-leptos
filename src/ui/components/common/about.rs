  ...
  view! {
      <div class="container mx-auto alert">
        ...
        <div>
          ...
          <p>"This is a techinical demo and proof of concept of the technical objectives specified by myself on my "<a class="link" href="//github.com/jim-taylor-business/lemmy-ui-leptos#objectives">"Lemmy UI Leptos homepage"</a>"."</p>
          <p>"It is also intended to be near feature complete with the homepage functionality of "<a class="link" href="//lemmy.world">"Lemmy world"</a>"."</p>
